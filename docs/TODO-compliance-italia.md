...
# TODO - acquistare il domain e creare la mail [EMAIL_ADDRESS]

creare account buttondown con quella mail e poi aggiornare l'informativa privacy con i dati corretti

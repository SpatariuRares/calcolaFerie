...
- [x] All 14 test cases above pass.
- [x] `vitest run` exits 0 with no skipped tests.
- [x] No test imports any internal engine helper — only `calculatePlan` and public types.
